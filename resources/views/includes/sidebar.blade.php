<div id="sidebar" class="active">
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative d-lg-none">
            ...
            <ul class="menu">
                <li class="sidebar-item">
                    <a href="index.html" class='sidebar-link'>
                        <img src="{{ asset('assets/images/logo/logo.svg') }}" class="img-fluid" alt="">
                    </a>
                </li>
                ...
                <li class="sidebar-title">Bank Data</li>
                <li class="sidebar-item {{ Route::is('class*') ? 'active' : '' }}">
                    <a href="{{ route('class.index') }}" class='sidebar-link'>
                        <i class="bi bi-house-fill"></i>
                        <span>Data Kelas</span>
                    </a>
                </li>
                <li class="sidebar-item  {{ Route::is('student*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item  {{ Route::is('perimeter*') ? 'active' : '' }}">
                    <a href="{{ route('perimeter.index') }}" class='sidebar-link'>
